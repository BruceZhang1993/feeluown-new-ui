...
from fuo_new_ui.gui.context.player import PlayerContext
...
class QmlApp(App):
    def __init__(self, *args, **kwargs):
        ...
        QmlApp.__q_app = QApplication.instance()

        self._engine = QQmlApplicationEngine()
        self._engine.quit.connect(QmlApp.__q_app.quit)
    ...
    def initialize(self):
        ...
        self._player_context = PlayerContext(self)
        self._engine.rootContext().setContextProperty("player", self._player_context)
        self._engine.load("feeluown/gui/qml/main.qml")
